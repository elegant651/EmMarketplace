...
const EmbarkJS = require("/Users/willpark/Desktop/partners/status/EmMarketplace/embarkArtifacts/modules/embarkjs").default || require("/Users/willpark/Desktop/partners/status/EmMarketplace/embarkArtifacts/modules/embarkjs");
EmbarkJS.environment = 'development';
global.EmbarkJS = EmbarkJS;

const Web3 = global.__Web3 || require('/Users/willpark/Desktop/partners/status/EmMarketplace/embarkArtifacts/modules/web3');
global.Web3 = Web3;

      const __embarkWeb3 = require('/Users/willpark/Desktop/partners/status/EmMarketplace/embarkArtifacts/modules/embarkjs-web3');
      EmbarkJS.Blockchain.registerProvider('web3', __embarkWeb3.default || __embarkWeb3);
      EmbarkJS.Blockchain.setProvider('web3', {});
    
if (!global.__Web3) {
  const web3ConnectionConfig = require('/Users/willpark/Desktop/partners/status/EmMarketplace/embarkArtifacts/config/blockchain.json');
  EmbarkJS.Blockchain.connect(web3ConnectionConfig, (err) => {if (err) { console.error(err); } });
      ...
      EmbarkJS.Blockchain.setProvider('web3', {web3});
        const __embarkWhisperNewWeb3 = require('/Users/willpark/Desktop/partners/status/EmMarketplace/embarkArtifacts/modules/embarkjs-whisper');
        EmbarkJS.Messages.registerProvider('whisper', __embarkWhisperNewWeb3.default || __embarkWhisperNewWeb3);
      
        const __embarkIPFS = require('/Users/willpark/Desktop/partners/status/EmMarketplace/embarkArtifacts/modules/embarkjs-ipfs');
